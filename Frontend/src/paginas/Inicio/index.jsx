          ...
          <div className={estilos.vantagens} data-test="vantagens">
            ...
            <div className={estilos.vantagens__itens} data-test="presente">
              <div className={estilos.vantagens__item}>
                <img data-test="icone" src={presente} alt="ícone de um presente" />
              ...
              <div className={estilos.vantagens__item} data-test="sacar">
                <img data-test="icone" src={saque} alt="ícone de uma mão segurando um dinheiro" />
              ...
              <div className={estilos.vantagens__item} data-test="pontos">
                <img data-test="icone" src={estrela} alt="ícone de uma estrela" />
              ...
              <div className={estilos.vantagens__item} data-test="dispositivos">
                <img
                  data-test="icone"
                  src={dispositivo}
